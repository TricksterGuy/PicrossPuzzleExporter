...
string(TOLOWER "gecodedriver" GECODE_LIB)
...
if(NOT "${GECODE_LIB_LOC}" STREQUAL "GECODE_LIB_LOC-NOTFOUND")
    get_filename_component(GECODE_LIB_HINT ${GECODE_LIB_LOC} DIRECTORY)
    list(APPEND GECODE_LIBRARY -L${GECODE_LIB_HINT})
endif()

foreach(GECODE_COMP ${Gecode_FIND_COMPONENTS})
  # Try to find gecode library
  string(TOLOWER "gecode${GECODE_COMP}" GECODE_LIB)
  set(GECODE_LIB_LOC "GECODE_LIB_LOC-NOTFOUND")
  find_library(GECODE_LIB_LOC NAMES ${GECODE_LIB} lib${GECODE_LIB} ${GECODE_LIB}-${GECODE_LIBRARY_VERSION}-r-x64 ${GECODE_LIB}-${GECODE_LIBRARY_VERSION}-d-x64
               HINTS ${GECODE_LIB_HINT})
  if(NOT "${GECODE_LIB_LOC}" STREQUAL "GECODE_LIB_LOC-NOTFOUND")
      get_filename_component(GECODE_LIB ${GECODE_LIB_LOC} NAME_WE)
      string(SUBSTRING ${GECODE_LIB} 3 -1 GECODE_LIB)
      list(APPEND GECODE_LIBRARY -l${GECODE_LIB})
      message(${GECODE_LIBRARY})
